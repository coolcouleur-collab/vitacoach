// Copie du greffon natif @perfood/capacitor-healthkit 1.3.2 (licence MIT,
// https://github.com/perfood/capacitor-healthkit), integree a la cible App
// le 6 septembre 2026.
//
// Pourquoi : le paquet npm n'a pas de Package.swift. Capacitor 8 en mode
// Swift Package Manager l'exclut donc du projet iOS (« does not have a
// Package.swift » a chaque cap sync), alors que capacitor.config.json
// demande bien la classe CapacitorHealthkitPlugin. Sans ce fichier, Apple
// Sante ne repond jamais sur iPhone.
//
// Seule modification par rapport a l'original : la classe adopte
// CAPBridgedPlugin et declare ses methodes en Swift, a la place de la
// macro CAP_PLUGIN du fichier CapacitorHealthkitPlugin.m. Le reste est
// intact. Si le greffon npm est mis a jour, comparer avec
// node_modules/@perfood/capacitor-healthkit/ios/Plugin/ et reporter ici.
...
public class CapacitorHealthkitPlugin: CAPPlugin, CAPBridgedPlugin {
    // Enregistrement au format Capacitor 6+, qui remplace la macro CAP_PLUGIN
    // du fichier .m d'origine. Les noms doivent rester identiques a ceux que
    // le JavaScript de @perfood/capacitor-healthkit appelle.
