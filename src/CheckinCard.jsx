                ...
                return (
                  <motion.button key={m.val}
                    ...
                    style={{
                      ...
                      background: active ? `rgba(${m.trame}, 0.149)` : (isNight ? 'rgba(180,210,255,0.10)' : 'rgba(var(--rgb-bulle), 0.55)'),
                      border: `1.5px solid ${active ? `rgba(${m.trame}, 0.533)` : ('rgba(var(--rgb-terracotta), 0.30)')}`,
