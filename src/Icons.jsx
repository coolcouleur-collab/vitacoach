...
export function CheckIcon({ color = '#22c55e', size = 14 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function HappyIcon({ color = '#22c55e', size = 20 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <circle cx="12" cy="12" r="10" stroke={color} strokeWidth="2"/>
...
export function BellIcon({ color = '#22c55e', size = 20 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function FoodIcon({ color = '#22c55e', size = 20 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function WeatherIcon({ color = '#E8962A', size = 20 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      <path d="M5 17a4 4 0 018 0" stroke={color} strokeOpacity="0.65" strokeWidth="2" strokeLinecap="round"/>
      <path d="M11 17a4 4 0 018 0" stroke={color} strokeOpacity="0.50" strokeWidth="2" strokeLinecap="round"/>
      <path d="M3 19h18" stroke={color} strokeOpacity="0.35" strokeWidth="2" strokeLinecap="round"/>
    </svg>
  )
}
