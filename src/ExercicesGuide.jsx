...
const AnimStepUp = () => (
  <DeuxPoses labelA="Pied sur la marche" labelB="Monte, pousse fort"
    poseA={<><path d="M58 92 L58 74 L92 74 L92 92" stroke="rgba(200,123,82,0.30)" strokeWidth="4" strokeLinecap="round" fill="none" /><circle cx="38" cy="26" r="7" {...S} /><path d="M38 33 L40 60 M38 40 L50 48 M40 60 L34 76 L34 92 M40 60 L58 66 L62 74" {...S} /></>}
    poseB={<><path d="M58 92 L58 74 L92 74 L92 92" stroke="rgba(200,123,82,0.30)" strokeWidth="4" strokeLinecap="round" fill="none" /><circle cx="64" cy="14" r="7" {...S} /><path d="M64 21 L66 46 M64 28 L76 36 M66 46 L62 62 L62 74 M66 46 L74 60 L74 74" {...S} /></>}
    duree={2.6}
  />
)
