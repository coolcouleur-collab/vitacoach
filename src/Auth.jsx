...
const s = {
  ...
  btn: { width:'auto', padding:'0.85rem 2.5rem', background:'linear-gradient(135deg,#8F3D14,#B3501F)', display:'block', margin:'12px auto 0',
    color:ENCRE, border:'1px solid rgba(143,61,20,0.55)', borderRadius:'2rem',
