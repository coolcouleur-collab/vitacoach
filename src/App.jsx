...
const st = {
  ...
  btn: { padding:'10px 16px', background:'linear-gradient(135deg,#af52de,#9b44cc)', color:'#fff',
    ...
    fontFamily:"'Inter',system-ui,sans-serif", boxShadow:'0 4px 12px rgba(175,82,222,0.3)' },
...
const s = {
  ...
  sidebar: {
    ...
    boxShadow:'4px 0 32px rgba(255,107,53,0.05)',
    display:'flex', flexDirection:'column',
    padding:'2.8rem 1.4rem 2.4rem',
    position:'fixed', top:0, left:0, height:'100vh',
    zIndex:50, overflowY:'auto',
  },
  sidebarTop: { marginBottom:'2.8rem', paddingBottom:'2rem', borderBottom:'1px solid #f0e8e0' },
  logo: {
  ...
  navActive: {
    display:'flex', alignItems:'center', gap:10, padding:'11px 14px', borderRadius:14,
    border:'none', background:'linear-gradient(135deg,rgba(255,107,53,.1),rgba(229,90,0,.06))',
    cursor:'pointer', fontFamily:F, color:'#FF6B35', fontWeight:700,
    textAlign:'left', width:'100%', fontSize:13, transition:'all .2s',
    boxShadow:'inset 0 0 0 1.5px rgba(255,107,53,.2)',
  },
  profileCard: {
    display:'flex', alignItems:'center', gap:10,
    background:'linear-gradient(135deg,rgba(255,107,53,.06),rgba(255,154,60,.04))',
    border:'1px solid rgba(255,107,53,.12)', borderRadius:14, padding:'12px 14px',
  },
  avatar: {
