...
const S = {
  ...
  cta: {
    width:'100%', padding:'17px', borderRadius:16, border:'1.5px solid rgba(200,123,82,0.35)',
    background:'linear-gradient(110deg, rgba(255,245,238,0.92) 0%, rgba(255,232,205,0.95) 55%, rgba(255,245,238,0.92) 100%)',
    backgroundSize:'250% 100%',
    color:'#B8683A', fontSize:16, fontWeight:700, cursor:'pointer',
    fontFamily:"'DM Sans', sans-serif", letterSpacing:'0.3px',
    boxShadow:'inset 0 1.5px 0 rgba(255,255,255,0.80), 0 4px 18px rgba(80,25,0,0.12)',
