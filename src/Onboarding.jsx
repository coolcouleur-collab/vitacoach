...
const s = {
  ...
  textInput: { width:'100%', maxWidth:440, padding:'20px 24px', borderRadius:20,
    border:'1.5px solid rgba(255,255,255,0.55)', background:'rgba(255,255,255,0.12)',
    backdropFilter:'blur(12px)', WebkitBackdropFilter:'blur(12px)',
    fontSize:22, fontFamily:'Poppins, sans-serif', color:'rgba(200,123,82,0.92)',
    outline:'none', textAlign:'center', fontWeight:700,
    boxShadow:'0 4px 24px rgba(200,123,82,0.08), inset 0 1px 0 rgba(255,255,255,0.20)',
  ...
  numberBox: { display:'flex', alignItems:'center', gap:8, borderRadius:20,
    padding:'12px 20px', background:'rgba(255,255,255,0.12)', border:'1.5px solid rgba(255,255,255,0.55)',
    backdropFilter:'blur(12px)', WebkitBackdropFilter:'blur(12px)',
    boxShadow:'0 4px 24px rgba(200,123,82,0.08), inset 0 1px 0 rgba(255,255,255,0.20)' },
