...
const s = {
  ...
  cardLabel: { fontSize:13, fontWeight:700, color:'rgba(140,75,20,0.88)', lineHeight:1.3 },
  cardSub:   { fontSize:11, color:'rgba(140,75,20,0.52)', lineHeight:1.3, fontWeight:500 },
  ...
  chip: { padding:'12px 20px', borderRadius:40, border:'1px solid rgba(255,255,255,0.55)',
    ...
    fontFamily:'Poppins, sans-serif', color:'rgba(140,75,20,0.82)',
  ...
  chipSel: { border:'1.5px solid rgba(218,138,52,0.50)',
    ...
    color:'rgba(140,75,20,0.92)', fontWeight:700,
  ...
  textInput: { width:'100%', maxWidth:440, padding:'20px 24px', borderRadius:20,
    ...
    fontSize:22, fontFamily:'Poppins, sans-serif', color:'rgba(140,75,20,0.88)',
  ...
  numberInput: { width:120, border:'none', background:'transparent', fontSize:52,
    fontFamily:'Poppins, sans-serif', color:'rgba(140,75,20,0.88)',
    outline:'none', textAlign:'center', fontWeight:900, padding:0 },
  unit: { fontSize:18, color:'rgba(140,75,20,0.50)', fontWeight:600 },
