...
const s = {
  ...
  card: { background:'rgba(255,255,255,0.45)', border:'1px solid rgba(218,138,52,0.12)', borderRadius:22,
  ...
  cardLabel: { fontSize:13, fontWeight:700, color:'rgba(200,120,60,0.80)', lineHeight:1.3 },
  cardSub:   { fontSize:11, color:'rgba(155,107,80,0.58)', lineHeight:1.3, fontWeight:500 },
  ...
  chip: { padding:'12px 20px', borderRadius:40, border:'1px solid rgba(218,138,52,0.18)',
    background:'rgba(255,255,255,0.45)', cursor:'pointer', fontSize:13,
    fontFamily:'Poppins, sans-serif', color:'rgba(218,138,52,0.62)',
    transition:'all 0.18s cubic-bezier(0.34,1.56,0.64,1)', fontWeight:600, outline:'none',
    boxShadow:'0 2px 8px rgba(218,138,52,0.06), inset 0 1px 0 rgba(255,255,255,0.7)' },
  chipSel: { border:'1.5px solid rgba(218,138,52,0.55)',
    background:'rgba(218,138,52,0.10)',
    color:'rgba(218,138,52,0.88)', fontWeight:700,
    boxShadow:'0 4px 14px rgba(218,138,52,0.15), inset 0 1px 0 rgba(255,255,255,0.6)',
  ...
  textInput: { width:'100%', maxWidth:440, padding:'20px 24px', borderRadius:20,
    border:'1.5px solid rgba(218,138,52,0.22)', background:'rgba(255,255,255,0.45)',
    fontSize:22, fontFamily:'Poppins, sans-serif', color:'rgba(218,138,52,0.85)',
    outline:'none', textAlign:'center', fontWeight:700,
    boxShadow:'0 4px 18px rgba(218,138,52,0.06), inset 0 1px 0 rgba(255,255,255,0.8)',
  ...
  numberBox: { display:'flex', alignItems:'center', gap:8, borderRadius:20,
    padding:'12px 20px', background:'rgba(255,255,255,0.45)', border:'1.5px solid rgba(218,138,52,0.20)' },
  numberInput: { width:120, border:'none', background:'transparent', fontSize:52,
    fontFamily:'Poppins, sans-serif', color:'rgba(218,138,52,0.85)',
    outline:'none', textAlign:'center', fontWeight:900, padding:0 },
  unit: { fontSize:18, color:'rgba(218,138,52,0.45)', fontWeight:600 },
  ...
  skipBtn: { background:'transparent', border:'none', color:'rgba(218,138,52,0.40)',
